...
<template>
    <div class="grid gap-8 place-content-center section">
        <div class="text-center space-y-5">
            <div class="grid place-content-center ">
                <CyUiCaption v-if="caption" :label="caption" class="" />
            </div>
        ...
        <div v-if="serviceList.length" class="flex flex-wrap md:flex-nowrap w-full justify-center gap-x-5 gap-y-8">
            <CyUiTeamMember v-for="item of serviceList" :img="(item.img as any)" :name="(item.name as any)"
